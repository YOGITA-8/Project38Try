...
function setup() {
    ...
    //create ship
    ship=createSprite(displayWidth/2 -300,displayHeight/2 -300);
...
function draw() {
    ...
    text("Score : " + score, displayWidth/2 -500, 30)
